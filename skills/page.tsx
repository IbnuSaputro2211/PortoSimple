        ...
        >
          {filteredSkills.map((skill, index) => (
            <motion.div
              ...
              className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700 hover:border-blue-500 transition-all duration-300 backdrop-blur-sm flex flex-col items-center"
            >
