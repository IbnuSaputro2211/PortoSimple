...
export default function Home() {
  ...
  // FIX: Move the useInView hooks to the top level rather than inside a callback
  ...
  // Create an array to store the refs and inView states for easy access in the JSX
  const timelineRefs = [
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="relative">
              {timelineItems.map((item, index) => {
                const { ref, inView } = timelineRefs[index]; // Use the individual ref and inView state for each item
