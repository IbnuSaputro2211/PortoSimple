  ...
  const portfolioItems: PortfolioItem[] = [ 
    {
      ...
      description: 'Skill spesial: Menulis, menghitung, dan tetap waras meski kurang tidur, sambil waspada terhadap serangan Fajarrr.',
    ...
    {
      id: '3',
      title: 'Kalkulator Modern - Lebih dari Sekadar Hitung-hitungan!',
    ...
    },
    {
      ...
      description: 'Keahlian unik dalam naik rank dengan penuh semangat, lalu turun dengan kecepatan kilat akibat tim noob dan sinyal Indosiar.',
      longDescription: 'Skill ini mencakup pengalaman bertahan di Mythical Glory meski naik turun kayak duit di dompet, penguasaan hero META (pas lagi buff doang), serta keahlian blaming tim setiap kalah. Selain itu, terbiasa melakukan epic comeback (kalau Hoki) dan adaptasi cepat terhadap patch baru yang bikin hero andalan mendadak useless. Juga memiliki mental baja menghadapi player Ngetrol, Bujang, dan player Feeder Pukimak yang penuh dengan kata Pantek, Hadehh!.',
      technologies: ['Macro Play', 'Micro Play', 'Map Awareness', 'Fast Hand (Opsional)', 'Sabar di Solo Rank', 'Selalu Istigfar', 'Mental Baja Lawan Bocil'],
